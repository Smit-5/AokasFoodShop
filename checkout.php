                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="checkout-address">
                        ...
                        <form class="needs-validation" novalidate>
                            ...
                            <div class="mb-3">
                                <label for="username">Additional Information Regarding Delivery</label>
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="shipping-method-box">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="ml-4 mb-2 small">(Free within 3 miles)</div>
                                    <div class="custom-control custom-radio">
                                        <input id="shippingOption2" name="shipping-option" class="custom-control-input" type="radio">
                                        <label class="custom-control-label" for="shippingOption2">3+ mile Delivery</label> <span class="float-right font-weight-bold">$10.00</span> </div>
                                    <div class="ml-4 mb-2 small">(Price varies as distance increase)</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-12">
