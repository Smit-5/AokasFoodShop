                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="name-pr">
                                        <a href="#">
									<?php if(isset($_SESSION['item_name'])){ echo $_SESSION['item_name']; }?>
								</a>
                                    </td>
                                    <td class="price-pr">
                                        <p><?php if(isset($_SESSION['item_offerprice'])){ echo $_SESSION['item_offerprice']; } ?></p>
                                    </td>
                                    ...
                                    <td class="remove-pr">
                                        <a href="<?php unset($_SESSION['item_name']); unset($_SESSION['item_offerprice']); ?>">
