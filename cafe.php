        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box" id='redirectLink' data-url='cafe-item.php'>
                        <img class="img-fluid" src="images/categories_img_01.jpg" alt="" width="360" height="200">
                        <a class="btn hvr-hover" href="cafe-item.php">BREAKFAST</a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box" id='redirectLink' data-url='cafe-item.php'>
                        ...
                        <a class="btn hvr-hover" href="cafe-item.php">BAGUETIES</a>
                    </div>
                </div>

                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/categories_img_01.jpg" alt="" /></a>
                        <a class="btn hvr-hover" href="cafe-item.php">BURGERS</a>
                    </div>
                </div>
